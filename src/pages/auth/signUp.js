  ...
  head() {
    return (
      <Helmet bodyAttributes={{ class: "signUpPage" }}>
        <title>Sign Up - Vegan Transitions</title>
      </Helmet>
    );
  }
    ...
    return (
      <div className="column column_12_12">
        ...
        <div className="signUp authForm">
          <h1 className="dark_headline">Join now</h1>
                ...
                <form onSubmit={event => this.handleSubmit(event, signupUser)}>
                  <div className="form_wrap">
                    ...
                    <div className="form_row">
                      <div className="form_item">
                        ...
                        <div className="helperText">
                          Please note that you will not be able to change this
                    ...
                    <div className="form_row">
                      ...
                      >
                        Please check that your passwords match and are at least
                        8 characters.
                      </div>
