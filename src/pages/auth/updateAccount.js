...
class UpdateAccount extends React.Component {
  ...
  validatePassword() {
    ...
    this.state;
    const isInvalid =
      !password || password !== passwordConfirm || password.length <= 2;
    return isInvalid;
  }
  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        <div className="column column_12_12">
          <div className="signUp authForm">
            <h1 className="dark_headline">Change your password</h1>
            ...
            >
              {(changePassword, { data, loading, error }) => {
                return (
                  <form
                    onSubmit={event =>
                      this.handleChangePassword(event, changePassword)
                    }
                  >
                    <div className="form_wrap updateAccountPasswordForm">
                      <div className="form_row">
                        ...
                        >
                          Please check that your passwords match and are at
                          least 8 characters.
                        </div>
